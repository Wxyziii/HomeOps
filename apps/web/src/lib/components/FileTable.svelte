...
<div class="file-table">
	<table>
		...
		<tbody>{#each files as file}<FileRow {file} {ondirectoryopen} {ondownload} {onextract} {ondetails} {onrename} {onmove} {ondelete} {allowDelete} {isUploading} {uploadForPath} />{/each}</tbody>
	</table>
</div>
